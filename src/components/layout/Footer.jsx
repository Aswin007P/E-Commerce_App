    ...
    <footer className="amazon-footer">
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-legal">
          <p>
            Copyright © {new Date().getFullYear()} FlipOn.com, Inc. or its affiliates. All rights reserved.
          </p>
